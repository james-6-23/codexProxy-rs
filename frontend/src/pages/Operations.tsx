              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                  ...
                  <OpsMetricCard
                    ...
                    sub={`${t('ops.memoryUsage', { used: formatBytes(overview.memory.used_bytes), total: formatBytes(overview.memory.total_bytes) })}${overview.memory.process_bytes ? ` · ${t('ops.processMemory', { size: formatBytes(overview.memory.process_bytes) })}` : ''}`}
